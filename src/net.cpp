...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Entropycoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"entropycointools.com", "dnsseed.entropycointools.com"},
    {"entropycoinpool.org", "dnsseed.entropycoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"entropycointools.com", "testnet-seed.entropycointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Entropycoin is probably already running."), addrBind.ToString().c_str());
        else
